...
import { getStaff } from '@/api/school';
import ProductCard from '@/components/staff-card/index.vue';
...
const productList = ref<Staff[]>();
const dataLoading = ref(true);

const fetchData = async () => {
  try {
    productList.value = await getStaff();
    pagination.value = {
      ...pagination.value,
