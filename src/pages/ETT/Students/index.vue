...
import { getStudent } from '@/api/school';
import ProductCard from '@/components/student-card/index.vue';
...
const productList = ref<Student[]>();
const dataLoading = ref(true);

const fetchData = async () => {
  try {
    productList.value = await getStudent();
    pagination.value = {
      ...pagination.value,
...
// const handleDeleteItem = (product: Room) => {
...
const onSubmit = (product: Student) => {
  console.log(product);
